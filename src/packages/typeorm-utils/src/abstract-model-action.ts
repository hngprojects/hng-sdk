...
export abstract class AbstractModelAction<T extends ObjectLiteral> {
  ...
  /**
   * Finds records with optional pagination and transaction support
   */
  ...
  /**
   * Lists records with filtering, relations, and pagination
   */
  ...
  /**
   * Saves an entity (useful for many-to-many relationships)
   */
